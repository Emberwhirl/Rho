...
assert.match(js, /function helpRecordFromResponse\(response\)/);
assert.match(js, /const record = helpRecordFromResponse\(recordResponse\)/);
assert.match(js, /const documentation = helpRecordFromResponse\(documentationResponse\)/);
