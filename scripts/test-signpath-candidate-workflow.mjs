...
function snapshot() {
  return {
    ...
    spec: read("docs/plans/active-2026-08-13-conditional-prerelease-policy-spec.md"),
...
function validate(value) {
  ...
  assert.match(value.spec, /Status: active; CPREL1 authorized/);
  ...
  assert.match(value.checklist, /deliberately limitations, not passed checks/);
