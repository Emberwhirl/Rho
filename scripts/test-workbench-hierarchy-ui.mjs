...
assert.match(html, /styles\.css\?v=0\.4\.0-dev\.28(?:&amp;|&)rev=m(?:2-workbench|3-scientific-review-v3)/);
assert.match(html, /app\.js\?v=0\.4\.0-dev\.28(?:&amp;|&)rev=m(?:2-workbench|3-scientific-review-v3)/);
