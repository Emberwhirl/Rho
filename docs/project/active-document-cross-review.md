...
| `plans/active-2026-08-05-native-context-lint-problems-editor-shortcuts-spec.md` | active; UX-CONTEXT-1, WS2-LINT-CALL-1, and WS2-LINT-ENTRY-1 implemented and verified; two separately committed packages remain | desktop context-menu policy, installed Lint transport, Check code entry, transient diagnostic clearing, and common editor shortcuts | WS2 diagnostics/refactor/format, WP3 durable Problems, UX-FIX2 Save, and M1-M3 presentation authority preserved; no schema or new mutation authority |
