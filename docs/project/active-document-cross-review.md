...
| `plans/active-2026-08-05-human-facing-information-projection-spec.md` | active; four presentation packages authorized 2026-08-05; implementation in progress | shared user-facing projection of internal identifiers, errors, statuses, paths, and implementation terminology | UX1 language authority and all existing workflow/backend authority preserved; installed/display-scale acceptance remains separate |
