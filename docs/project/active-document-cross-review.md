...
| `plans/active-2026-08-05-macos-arm64-support-spec.md` | active; MAC1 implementation/review complete; MAC2 authorized 2026-08-05; Windows CI/installed acceptance open | Apple Silicon macOS 14+ platform adapters, Ark/R integration, Keychain extension, additive macOS update artifact, and signed DMG handoff | MAC2 stops after the bundled Ark/arm64 R vertical slice and recovery evidence; MAC3-MAC5 each require a separately recorded entry review and authorization |
