...
| `plans/active-2026-08-13-dev38-test-signed-prerelease-spec.md` | active authorized DEV38-SIGN1 contract; source implementation, exact candidate, installed acceptance, MAC5, publication, and update projection remain separate gates | fresh `0.4.0-dev.38` identity, candidate-only Free Trial self-signed installer request/evidence, truthful public trust wording, exact installed ledger, and publication decision | preserve rehearsal as unsigned/review-only, never reuse FT-SIGN1 `dev.37` bytes, keep Foundation/production authority in SP-READY1, and do not publish before exact human acceptance plus MAC5 GO |
...
| `release/active-0.4.0-dev.38-candidate-checklist.md` | active DEV38-SIGN1 ledger; source implementation authorized, all exact source/artifact/installed/MAC5/publication evidence open | sole `0.4.0-dev.38` identity, final candidate hashes, installed observations, acceptance asset, GO/NO-GO, and publication/update reconciliation | no `dev.37` evidence is composable; candidate mode requires fresh Free Trial signing evidence; publication remains NO-GO until exact human Windows/macOS acceptance and MAC5 GO |
