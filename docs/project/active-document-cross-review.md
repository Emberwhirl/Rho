...
| `release/active-0.4.0-dev.31-candidate-checklist.md` | active replacement source-candidate contract; DATA-VIEWER-ROW-SHAPE-R1 implementation, complete affected source validation/review, exact four-identity hosted run `31523265847`, and upstream PR #39 integration at `a54fa2c` pass | sole `0.4.0-dev.31` source identity and future exact candidate, installed, MAC5, publication, and updater evidence | no artifact, Draft, tag, installed acceptance, MAC5, publication, or updater mutation exists yet; all `dev.30` evidence is non-composable; exact browser/mock, Windows/macOS installed, Windows signing disposition, and release gates remain open |
...
| `plans/active-2026-08-11-data-viewer-row-shape-repair-spec.md` | active; DATA-VIEWER-ROW-SHAPE-R1 implementation, source validation/review, hosted matrix, and PR #39 integration complete; exact replacement candidate acceptance open | conformance of existing WP2 `cells`/`cell_states` ordered-array response shape, end-to-end shape verification, and truthful viewer failure classification | implemented WP2 retains object/view/page/revision/bounds authority; WS3-Q1/Q2 retain query/sort/type/cell-state semantics; Issue #33 retains presentation focus/refresh authority; no schema, mutation, polling, project, approval, credential, export, or release authority; fresh `dev.31` identity required before distribution |
