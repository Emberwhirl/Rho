...
| `plans/active-2026-08-05-macos-arm64-support-spec.md` | active; MAC1-MAC4 implementation/review complete; `dev.24` authoritative candidate/draft, owner-installed acceptance, and MAC5 GO pass; first protected publish fails closed before mutation on draft-by-tag lookup and its bounded release-only repair is authorized | Apple Silicon macOS 14+ platform adapters, Ark/R integration, Keychain extension, additive macOS update artifact, signed DMG handoff, repository-bound rehearsal lane, async notarization orchestration, and MAC5 publication admission | land the reviewed ID-based draft lookup repair, retry protected publication without changing accepted assets, then verify Pages; macOS x64 and Linux x64 remain open |
...
| `release/active-0.4.0-dev.24-candidate-checklist.md` | active accepted identity; exact candidate/draft, signed/notarized DMG, installed acceptance, bounded MAC5 GO evidence, and public-release authorization pass; publish run `31297205980` fails closed before mutation; ID-based repair is implemented, locally verified, and independently reviewed | sole live `0.4.0-dev.24` cross-platform identity, immutable asset/evidence binding, installed-acceptance ledger, GO decision, and release-only repair gate | push the scoped repair to `main`, retry protected publication, then verify Pages; accepted candidate assets remain unchanged |
