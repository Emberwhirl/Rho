...
| `plans/active-2026-08-03-ew-cr2-structural-claim-review-spec.md` | active repair; post-commit review reopened five contract gaps 2026-08-03; source-range repair implemented and verified, four repairs pending | project-scoped claim records, exact source/Artifact anchors, same-project Evidence links, and deterministic structural review statuses | Evidence entries remain EW-CR1 authority; WP3 owns Artifact provenance; BH1/BH3 own identity/migration; no semantic verdict, Agent authority, export, public protocol, or publication acceptance |
