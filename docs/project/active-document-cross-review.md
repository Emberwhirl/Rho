...
| `plans/active-2026-08-04-agent-execution-output-review-repair-spec.md` | active; AGENT-LOOP-1 implemented and automated/browser verified 2026-08-04; installed acceptance open | display-only path cleanup, direct Act execution instruction, and Agent-first Outputs-to-Review loop over existing Plots and WP3 Artifacts | existing project/revision/approval/tool guards preserved; no new schema or authority; exact installed-candidate acceptance remains open |
