...
| `plans/active-2026-08-04-five-usability-repairs-spec.md` | active; five bounded work packages authorized 2026-08-04; UX-FIX1 through UX-FIX4 implemented and automated/browser verified | truthful Problem navigation, explicit save shortcut, clearer file hierarchy, Console focus, and human-reviewable Agent Runs/Review projection | stop after each scoped commit; UX-FIX5 next; WP3/UX4/M1-M3/CL1/WS2 authority preserved; installed acceptance remains open |
