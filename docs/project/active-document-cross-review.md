...
| `plans/active-2026-08-05-macos-arm64-support-spec.md` | active; MAC1-MAC4 implementation/review complete; earlier rehearsal history preserved; Issue #6 `dev.20`-`dev.22` identities rejected and `dev.23` superseded before artifact production; Issue #9 advances the live identity to `0.4.0-dev.24` | Apple Silicon macOS 14+ platform adapters, Ark/R integration, Keychain extension, additive macOS update artifact, signed DMG handoff, repository-bound rehearsal lane, and async notarization orchestration | MAC4-R3 remains closed at its review-only evidence; dev.24 complete matrix/artifact and owner-installed/live-Provider acceptance remain open; MAC5 remains unauthorized; full M3 retains authoritative candidate, macOS x64, and Linux x64 gates |
...
| `release/active-0.4.0-dev.24-candidate-checklist.md` | active replacement identity; Issue #6 R5 and Issue #9 Task Rail source implementation present; affected frontend/static/exact-browser validation pass; one exact-default-branch review-only `Rho_for_mac` rehearsal authorized 2026-08-09 with result open | sole live `0.4.0-dev.24` cross-platform candidate identity, future evidence binding, installed-acceptance ledger, and GO/NO-GO decision | review-only rehearsal may run with its coupled platform jobs; owner-installed/live-Provider acceptance remains separate; candidate mode, MAC5, upload, and publication remain separately gated |
