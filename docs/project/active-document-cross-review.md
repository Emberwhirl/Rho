...
| `plans/active-2026-08-05-macos-arm64-support-spec.md` | active; MAC1-MAC4 implementation/review complete; earlier rehearsal history preserved; Issue #6 `dev.20`-`dev.22` identities rejected and `dev.23` superseded before artifact production; Issue #9 advances the live identity to `0.4.0-dev.24`; exact fork rehearsal `31294667960` passes and authoritative candidate/draft entry is authorized | Apple Silicon macOS 14+ platform adapters, Ark/R integration, Keychain extension, additive macOS update artifact, signed DMG handoff, repository-bound rehearsal lane, and async notarization orchestration | dispatch exact post-amendment upstream candidate/draft; then owner-installed/live-Provider acceptance; MAC5 GO, public publication, macOS x64, and Linux x64 remain open |
...
| `release/active-0.4.0-dev.24-candidate-checklist.md` | active replacement identity; Issue #6 R5 and Issue #9 Task Rail source implementation present; affected frontend/static/exact-browser validation and exact fork rehearsal pass; authoritative candidate/draft entry authorized 2026-08-09 | sole live `0.4.0-dev.24` cross-platform candidate identity, future evidence binding, installed-acceptance ledger, and GO/NO-GO decision | exact post-amendment upstream candidate/draft may run; owner-installed/live-Provider acceptance remains separate; MAC5 GO, public publication, and update-site mutation remain gated |
