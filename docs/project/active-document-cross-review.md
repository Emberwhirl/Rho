...
| `plans/active-2026-07-31-ra-rc1-run-comparison-handoff.md` | active | read-only deterministic two-run comparison over existing durable records (Phase A-D) | RA-RC1 is active and stops for review after Phase A backend comparison engine and store tests |
