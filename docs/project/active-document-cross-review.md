...
| `release/active-0.4.0-dev.30-candidate-checklist.md` | active exact-candidate contract; Issue #33 source/review integrated; exact current-main run `31515775702` and independently verified seven-asset Draft `368736031` at `bcc8e1c` pass; browser/mock, installed Windows/macOS, Windows signing disposition, MAC5, and publication open | sole `0.4.0-dev.30` source/candidate identity, exact Draft evidence, and future installed, MAC5, and publication evidence | preserve the immutable Draft; complete browser/mock and exact installed acceptance, resolve Issue #26 signing disposition, and require explicit candidate-bound MAC5 GO before acceptance upload or publish; Issue #33 remains open; `dev.29` evidence is non-composable; package versions and schema 12 remain unchanged |
