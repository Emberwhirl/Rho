...
- Active conditional-prerelease policy: [`plans/active-2026-08-13-conditional-prerelease-policy-spec.md`](plans/active-2026-08-13-conditional-prerelease-policy-spec.md)
...
- Active `0.4.0-dev.39` conditional prerelease gate: [`release/active-0.4.0-dev.39-candidate-checklist.md`](release/active-0.4.0-dev.39-candidate-checklist.md)
