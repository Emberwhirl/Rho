...
The remaining manual steps and candidate record are consolidated under
`test/acceptance-project/`, with the interface checks in
`MANUAL-ACCEPTANCE.md` section 8A; they are currently NOT RUN.
