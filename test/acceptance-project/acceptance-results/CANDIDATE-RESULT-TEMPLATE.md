...
Record the pass, fail, or justified skip for every applicable gate in
`../../../docs/acceptance/manual-acceptance-checklist.md`. Add screenshot or log
paths here, along with the first failing step and reproduction details.
